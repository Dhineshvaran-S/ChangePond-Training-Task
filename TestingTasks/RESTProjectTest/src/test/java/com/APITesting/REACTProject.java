  ...
  // @Test
   ...
   @Test
    ...
    public void PATCHRequest() {
    	...
    	request.put("userId","dhineshvaran2000@gmail.com");



		request.put("userPass","Dhinesh@123");
		...
		body(request.toJSONString()).patch("/user/503").then().statusCode(200).log().all();
